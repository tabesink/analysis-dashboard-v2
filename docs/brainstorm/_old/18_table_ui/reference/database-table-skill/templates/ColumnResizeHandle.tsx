...
/**
 * Verbatim port of client/src/components/upload/ColumnResizeHandle.tsx.
 *
 * 1.5px-wide vertical strip pinned to the right edge of a column header. Drag
 * to resize. While dragging, locks document.body cursor + userSelect through a
 * global event listener so the cursor doesn't flicker as the pointer crosses
 * text nodes.
 */
