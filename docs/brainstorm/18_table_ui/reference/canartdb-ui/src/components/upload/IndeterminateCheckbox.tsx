...
/**
 * Verbatim port of `.cursor/skills/database-table/templates/IndeterminateCheckbox.tsx`.
 *
 ...
 *
 * The `onClick` `stopPropagation` is mandatory: without it, clicking the
 * checkbox also toggles the surrounding `Collapsible`.
 */
